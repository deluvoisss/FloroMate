...
const LIBRARY: LibraryItem[] = [
  ...
  { id: 'f_home', name: 'home', type: 'furniture', icon: '🏠', color: '#8b6f47', width: 150, height: 150 },
  { id: 'f_home1', name: 'home1', type: 'furniture', icon: '🏠', color: '#8b6f47', width: 300, height: 500 },
  { id: 'f_home2', name: 'home2', type: 'furniture', icon: '🏠', color: '#8b6f47', width: 150, height: 150 },// Вода
...
{ id: 'w2', name: 'tree', type: 'water', icon: '⛲', color: '#87ceeb', width: 80, height: 80 },
    ...
    <div className="home-page">
      <header className="header">
        <div className="header-content">
          <h1>🌿 LandscapeAI</h1>
          <p>Создайте идеальный ландшафт участка за минуты</p>
        </div>
      </header>

      <section className="hero">
        <div className="hero-content">
          <h2>Дизайн сада с помощью ИИ</h2>
          <p>Загрузите фото участка, выберите стиль — и AI создаст несколько вариантов дизайна</p>
      ...
      <section className="how-it-works">
        ...
        <div className="steps">
          <div className="step">
            ...
            <p>Сфотографируйте ваш участок с разных углов</p>
          </div>
          <div className="step">
            <div className="step-number">2</div>
            <h3>Выберите стиль</h3>
            <p>Выберите понравившийся стиль дизайна из предложенных</p>
          </div>
          <div className="step">
            <div className="step-number">3</div>
            <h3>Получите варианты</h3>
            <p>AI создаст несколько вариантов дизайна за секунды</p>
          </div>
          <div className="step">
            <div className="step-number">4</div>
            <h3>Доработайте</h3>
            <p>Отредактируйте дизайн вручную или покажите архитектору</p>
          </div>
        </div>
      </section>
      ...
      <section className="features">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <h3>AI-генерация дизайна</h3>
            <p>Искусственный интеллект создаст варианты в выбранном стиле</p>
          </div>
          <div className="feature-card">
            <span className="feature-icon">✏️</span>
            <h3>Ручное редактирование</h3>
            <p>Перетаскивайте растения, мебель и другие элементы</p>
          </div>
          <div className="feature-card">
            <span className="feature-icon">3️⃣</span>
            <h3>2D и 3D вид</h3>
            <p>Смотрите проект с разных углов и в деталях</p>
          </div>
          <div className="feature-card">
            <span className="feature-icon">📊</span>
            <h3>Расчет стоимости</h3>
            <p>Автоматический подсчет бюджета на реализацию</p>
          </div>
          <div className="feature-card">
            <span className="feature-icon">📥</span>
            <h3>Экспорт в PDF</h3>
            <p>Скачайте проект в формате PDF или для печати</p>
          </div>
          <div className="feature-card">
            <span className="feature-icon">💾</span>
            <h3>Сохранение проектов</h3>
            <p>Все проекты сохраняются локально на вашем компьютере</p>
          </div>
        </div>
      </section>

      <footer className="footer">
        <p>LandscapeAI © 2025 | Бесплатный инструмент для ландшафтного дизайна</p>
      </footer>
    </div>
  );
};
...
// ============ КОМПОНЕНТ: РЕДАКТОР ============
const Editor: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  ...
  const [project, setProject] = useState<Project>({
    ...
    gridSize: 40,
    groundType: 'grass',  // добавлено
    showGrid: true,       // добавлено
  });
        ...
        <aside className="properties-panel">
          ...
          {selectedObject ? (
            ...
            <div className="no-selection">
              <p>Нажмите на объект на сцене, чтобы отредактировать его</p>
            </div>
          )}
...
export default function App() {
  ...
  return (
    <div className="app">
      {currentPage === 'home' ? (
        <HomePage onStart={() => setCurrentPage('editor')} />
      ) : (
        <Editor onBack={() => setCurrentPage('home')} />
      )}
    </div>
  );
}